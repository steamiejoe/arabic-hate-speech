...
## Dataset Summary
This dataset is a harmonization of six open-source Arabic hate speech corpora, re-mapped to a unified taxonomy (Normal, Gender Hate, Origin Hate, Religious Hate). It can be downloaded from the data folder upon running notebooks 01 and 02.
...
7. **Arabic Hate Speech Superset:** Tonneau et al. (2024)
